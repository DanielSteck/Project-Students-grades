...
Using of plumber in order to deploy the model with vetiver.
...
-   venticer_renv_lock file to capture the model dependencies.
...
Sadly this prediction is not working as I allways get the error message, that the connection is refused...
