...
For this project the visualizations of categorical and the target variable will be made with box plots, dentistry plots, violin plots and histograms in order to show the different possibilities in R. Therefore the variables will be displayed in different graphical visualizations. 
...
**Impact test preparation course on Avg_score**
