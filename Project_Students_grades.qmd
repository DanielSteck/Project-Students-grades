...
This project was created within the modul "Programming languages for Data Science.This project will follow the data science lifecycle, which consists of four main topics:
...
The whole documentation of this project can be also found on [Github Repo: Student Grades](https://github.com/DanielSteck/Project-Students-grades)
...
-   https://colorado.posit.co/rsc/bike-predict-r-model-metrics/document.html

-   https://rstudio.github.io/vetiver-r/reference/vetiver_compute_metrics.html

-   https://vetiver.rstudio.com/get-started/monitor.html
...
rsconnect::setAccountInfo(name='danielsteck',
			  token='27FA72E141C5D1C0E638BBD54BB2421B',
			  secret='<SECRET>')
```
