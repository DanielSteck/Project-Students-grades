...
Due to the fact that a numeric target variable shall be predicted this project focuses on the supervised learning and a regression model shall be made.
...
This project has several aspects which determine that is was successful. Note all aspects need to be fulfilled, but there are some targets which should be fulfilled.
One of this aspects is that new insights are made based on the available data set and our costumer can use this information as a basis for their decisions. It would be great if these results could be visualized in an interactive dashboard to work with the data.
...
- **RMSE/MSE:** Root Mean Squared Error / Mean Squared Error
